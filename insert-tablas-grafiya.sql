...
INSERT INTO categorias (id,imagen,orden,activa, nombre, descripcion) VALUES(0,'no-imagen.jpg',1,1,'Tienda', 'Categoria muestra todos los productos de nuestra tienda');
INSERT INTO categorias (id,imagen,orden,activa, nombre, descripcion) VALUES(1,'no-imagen.jpg',2,1,'Tazas', 'Una descripcion para tazas personalizadas');
INSERT INTO categorias (id,imagen,orden,activa, nombre, descripcion) VALUES(2,'no-imagen.jpg',3,1,'Termos y botellas', 'Una descripcion para termos y botellas');
INSERT INTO categorias (id,imagen,orden,activa, nombre, descripcion) VALUES(3,'no-imagen.jpg',4,1,'Vasos', 'Una descripcion para vasos de vidirio');
...
INSERT INTO productos (codigo,nombre,	descripcion,	peso,	imagen,	umbral_poca_cantidad,	umbral_cantidad_agotada,	cantidad_stock,	min_cantidad_pedido,	max_cantidad_pedido,	grupos_de,	costo_unitario,	create_at,	visible_en_tienda,	activo,	color_id,	material_id	,categoria_id,	uso_id, impuesto_igv, estado_producto_id) VALUES('SR2','Servicio de diseño gráfico','Servicio diseño y retoque de imágen',NULL,'no-imagen.jpg',1,0,99999999,1,1,1,7,now(),0,1,18,9,6,5,18,5);
INSERT INTO productos (codigo,nombre,	descripcion,	peso,	imagen,	umbral_poca_cantidad,	umbral_cantidad_agotada,	cantidad_stock,	min_cantidad_pedido,	max_cantidad_pedido,	grupos_de,	costo_unitario,	create_at,	visible_en_tienda,	activo,	color_id,	material_id	,categoria_id,	uso_id, impuesto_igv, estado_producto_id) VALUES('SR3','Servicio de entrega local','Servicio de envió a domicilio en la ciudad',NULL,'no-imagen.jpg',1,0,99999999,1,1,1,11,now(),0,1,18,9,6,6,18,5);
INSERT INTO productos (codigo,nombre,	descripcion,	peso,	imagen,	umbral_poca_cantidad,	umbral_cantidad_agotada,	cantidad_stock,	min_cantidad_pedido,	max_cantidad_pedido,	grupos_de,	costo_unitario,	create_at,	visible_en_tienda,	activo,	color_id,	material_id	,categoria_id,	uso_id, impuesto_igv, estado_producto_id) VALUES('SR4','Servicio de entrega a provincias','Servicio de envió a domicilio en otra ciudad',NULL,'no-imagen.jpg',1,0,99999999,1,1,1,50,now(),0,1,18,9,6,6,18,5);
