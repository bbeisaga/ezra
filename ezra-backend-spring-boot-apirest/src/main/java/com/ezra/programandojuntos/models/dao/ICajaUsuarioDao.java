...
public interface ICajaUsuarioDao extends CrudRepository<CajaUsuario, Long>{
	...
	@Transactional
	@Modifying
	@Query (value = "INSERT INTO caja_usuarios (fecha_apertura, saldo_caja, saldo_por_conteo, ingreso_esperado, egreso_esperado, activa, caja_id, usuario_id) VALUES (?1, ?2, ?3, 0, 0, ?4, ?5, ?6);" ,nativeQuery = true)
